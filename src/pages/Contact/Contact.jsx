...
<div className={`${location.pathname !== '/' ? 'page-transition3' : ''}`}></div>
            ...
            <Link to={'https://wa.me/+541135562843'} className='ContactLink' target='_blank'><div className="contactItemDiv"><i className="fa-brands fa-whatsapp"></i>11-35562843</div></Link>
